 ...
 * element interface generated in the ca.savinetwork.testbed.type.hardwareschema
 * package.
 * <p>
...
public class ObjectFactory {
  private final static QName _TerminateRequest_QNAME = new QName(
      "hardware.XSD.AOR", "terminateRequest");
  private final static QName _InitRequest_QNAME = new QName("hardware.XSD.AOR",
      "initRequest");

  /**
   * Create a new ObjectFactory that can be used to create new instances of
   * schema derived classes for package:
   * ca.savinetwork.testbed.type.hardwareschema
   */
  ...
  /**
   * Create an instance of {@link SetResourceParametersRequest.MAC }
   */
  public SetResourceParametersRequest.MAC
      createSetResourceParametersRequestMAC() {
    return new SetResourceParametersRequest.MAC();
  }
   ...
   */
  @XmlElementDecl(namespace = "hardware.XSD.AOR", name = "terminateRequest")
   ...
   * Create an instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
   */
  @XmlElementDecl(namespace = "hardware.XSD.AOR", name = "initRequest")
